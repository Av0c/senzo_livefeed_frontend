...
import {fetchAreaData, applyAreaQuery, exportAreaUtilizationCsv} from 'actions/locations';

class AreaView extends React.Component {

  componentDidMount() {
    this.props.dispatch(fetchAreaData(this.props.params.id, this.props.querySettings))
  }

  componentWillReceiveProps(nextProps) {
    switch (true) {
      case nextProps.querySettings.period.code != this.props.querySettings.period.code:
        this.props.dispatch(applyAreaQuery(nextProps.params.id, nextProps.querySettings));
        break;
      case nextProps.querySettings.mode.code != this.props.querySettings.mode.code:
        this.props.dispatch(applyAreaQuery(this.props.params.id, nextProps.querySettings));
        break;
      case nextProps.params.id !== this.props.params.id:
        this.props.dispatch(fetchAreaData(nextProps.params.id, nextProps.querySettings));
        break;
...
function mapStateToProps(state){
  return {
    ...
    state: state.locationsReducer.area,
