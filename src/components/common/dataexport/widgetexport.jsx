...
class WidgetExport extends React.Component {
    ...
    render() {
        return (
            <div>
                <Dropdown header={
                    <div className={"text-center widget-export " + (this.state.loading ? "loading" : "")}>
                        {
                            this.state.loading ?
...
export default connect(mapStateToProps, mapDispatchToProps)(WidgetExport);