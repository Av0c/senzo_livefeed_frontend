...
class OverviewLeft extends React.Component {
  ...
  render() {
    ...
    var stas = this.countTreeStatistic(this.props.currentNode, this.props.currentSensor);
    return (
              ...
              <div className="the-card clearfix">
                ...
                <div className="card-stats-numeric clearfix">
                  <div className="total-rooms-container text-center pull-left">
                    ...
                    <div className="total-rooms-number"><span>{stas.allRooms}</span></div>
                    <div className="total-rooms-inuse"><span id="rooms-inuse">{stas.roomsInUse}</span><span> in use   </span></div>
                  </div>
                  <div className="total-desks-container text-center pull-right">
                    <div className="total-desks-title"><span>Total Desks</span></div>
                    <div className="total-desks-number"><span>{stas.allSensors}</span></div>
                    <div className="total-desks-inuse"><span id="desks-inuse">{stas.desksInUse}</span><span> in use   </span></div>
                  </div>
                </div>
