        ...
        return (
            <div className={(!this.props.disabled) ? "card-container flat-popup" : "card-container flat-popup card-disabled"}>
                <div className="card-bar">
                    <div className="card-title">{this.props.title + " " + this.props.periodType}</div>
                    <div className="card-info">{"(" + this.props.startDate.replace(/-/g, "/") + " - " + this.props.endDate.replace(/-/g, "/") + ")"}</div>
